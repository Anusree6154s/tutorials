...
import { increment, decrement, incrementByAmount, decrementByAmount, getUserId } from "../slices/accountSlice";
...
export default function Account() {
  ...
  return (
    <div>
      ...
      {
        account.error ? <p>{account.error}</p> : <h3>Amount: ${amount}</h3>
      }
      ...
      <button onClick={() => dispatch(decrementByAmount(value3))}>decrement by {value3}</button>
      </p>
     <p>
